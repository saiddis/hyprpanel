...
func (x *HostServiceIdleInhibitorToggleRequest) Reset() {
	*x = HostServiceIdleInhibitorToggleRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *HostServiceIdleInhibitorToggleRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HostServiceIdleInhibitorToggleRequest) ProtoMessage() {}

func (x *HostServiceIdleInhibitorToggleRequest) ProtoReflect() protoreflect.Message {
	mi := &file_hyprpanel_v1_hyprpanel_proto_msgTypes[41]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HostServiceIdleInhibitorToggleRequest.ProtoReflect.Descriptor instead.
func (*HostServiceIdleInhibitorToggleRequest) Descriptor() ([]byte, []int) {
	return file_hyprpanel_v1_hyprpanel_proto_rawDescGZIP(), []int{41}
}

func (x *HostServiceIdleInhibitorToggleRequest) GetTarget() v11.InhibitTarget {
	if x != nil {
		return x.Target
	}
...
type HostServiceIdleInhibitorToggleResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *HostServiceIdleInhibitorToggleResponse) Reset() {
...
func (x *HostServiceIdleInhibitorToggleResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HostServiceIdleInhibitorToggleResponse) ProtoMessage() {}

func (x *HostServiceIdleInhibitorToggleResponse) ProtoReflect() protoreflect.Message {
	mi := &file_hyprpanel_v1_hyprpanel_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HostServiceIdleInhibitorToggleResponse.ProtoReflect.Descriptor instead.
func (*HostServiceIdleInhibitorToggleResponse) Descriptor() ([]byte, []int) {
...
var file_hyprpanel_v1_hyprpanel_proto_rawDesc = []byte{
	...
	,
	...
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x68, 0x79, 0x70, 0x72, 0x70, 0x61, 0x6e, 0x65, 0x6c, 0x2e, 0x76,
	0x31, 0x2e, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x4e, 0x52, 0x47, 0x42, 0x41, 0x52, 0x05, 0x69, 0x6d,
	0x61, 0x67, 0x65, 0x2a, 0x9a, 0x01, 0x0a, 0x18, 0x53, 0x79, 0x73, 0x74, 0x72, 0x61, 0x79, 0x53,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xf8, 0x10, 0x0a, 0x0b, 0x48, 0x6f,
	...
	0x65, 0x12, 0x80, 0x01, 0x0a, 0x13, 0x49, 0x64, 0x6c, 0x65, 0x49, 0x6e, 0x68, 0x69, 0x62, 0x69,
	0x74, 0x6f, 0x72, 0x54, 0x6f, 0x67, 0x67, 0x6c, 0x65, 0x12, 0x33, 0x2e, 0x68, 0x79, 0x70, 0x72,
	...
	,
...
var file_hyprpanel_v1_hyprpanel_proto_goTypes = []interface{}{
	...
	(*HostServiceIdleInhibitorToggleRequest)(nil),         // 44: hyprpanel.v1.HostServiceIdleInhibitorToggleRequest
	(*HostServiceIdleInhibitorToggleResponse)(nil),        // 45: hyprpanel.v1.HostServiceIdleInhibitorToggleResponse
...
var file_hyprpanel_v1_hyprpanel_proto_depIdxs = []int32{
	...
	53, // 13: hyprpanel.v1.HostServiceIdleInhibitorToggleRequest.target:type_name -> hyprpanel.event.v1.InhibitTarget
	...
	44, // 34: hyprpanel.v1.HostService.IdleInhibitorToggle:input_type -> hyprpanel.v1.HostServiceIdleInhibitorToggleRequest
	6,  // 35: hyprpanel.v1.PanelService.Init:output_type -> hyprpanel.v1.PanelServiceInitResponse
	8,  // 36: hyprpanel.v1.PanelService.Notify:output_type -> hyprpanel.v1.PanelServiceNotifyResponse
	12, // 37: hyprpanel.v1.PanelService.Close:output_type -> hyprpanel.v1.PanelServiceCloseResponse
	14, // 38: hyprpanel.v1.HostService.Exec:output_type -> hyprpanel.v1.HostServiceExecResponse
	16, // 39: hyprpanel.v1.HostService.FindApplication:output_type -> hyprpanel.v1.HostServiceFindApplicationResponse
	18, // 40: hyprpanel.v1.HostService.SystrayActivate:output_type -> hyprpanel.v1.HostServiceSystrayActivateResponse
	20, // 41: hyprpanel.v1.HostService.SystraySecondaryActivate:output_type -> hyprpanel.v1.HostServiceSystraySecondaryActivateResponse
	22, // 42: hyprpanel.v1.HostService.SystrayScroll:output_type -> hyprpanel.v1.HostServiceSystrayScrollResponse
	24, // 43: hyprpanel.v1.HostService.SystrayMenuContextActivate:output_type -> hyprpanel.v1.HostServiceSystrayMenuContextActivateResponse
	26, // 44: hyprpanel.v1.HostService.SystrayMenuAboutToShow:output_type -> hyprpanel.v1.HostServiceSystrayMenuAboutToShowResponse
	28, // 45: hyprpanel.v1.HostService.SystrayMenuEvent:output_type -> hyprpanel.v1.HostServiceSystrayMenuEventResponse
	30, // 46: hyprpanel.v1.HostService.NotificationClosed:output_type -> hyprpanel.v1.HostServiceNotificationClosedResponse
	32, // 47: hyprpanel.v1.HostService.NotificationAction:output_type -> hyprpanel.v1.HostServiceNotificationActionResponse
	34, // 48: hyprpanel.v1.HostService.AudioSinkVolumeAdjust:output_type -> hyprpanel.v1.HostServiceAudioSinkVolumeAdjustResponse
	36, // 49: hyprpanel.v1.HostService.AudioSinkMuteToggle:output_type -> hyprpanel.v1.HostServiceAudioSinkMuteToggleResponse
	38, // 50: hyprpanel.v1.HostService.AudioSourceVolumeAdjust:output_type -> hyprpanel.v1.HostServiceAudioSourceVolumeAdjustResponse
	40, // 51: hyprpanel.v1.HostService.AudioSourceMuteToggle:output_type -> hyprpanel.v1.HostServiceAudioSourceMuteToggleResponse
	42, // 52: hyprpanel.v1.HostService.BrightnessAdjust:output_type -> hyprpanel.v1.HostServiceBrightnessAdjustResponse
	46, // 53: hyprpanel.v1.HostService.CaptureFrame:output_type -> hyprpanel.v1.HostServiceCaptureFrameResponse
	45, // 54: hyprpanel.v1.HostService.IdleInhibitorToggle:output_type -> hyprpanel.v1.HostServiceIdleInhibitorToggleResponse
...
func file_hyprpanel_v1_hyprpanel_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_hyprpanel_v1_hyprpanel_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HostServiceIdleInhibitorToggleRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_hyprpanel_v1_hyprpanel_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HostServiceIdleInhibitorToggleResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
